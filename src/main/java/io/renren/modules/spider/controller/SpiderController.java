...
public class SpiderController{
    private Logger LOG = LogManager.getLogger(SpiderController.class);
    @Autowired
    ...
    @ResponseBody
    public R testSpiderInfo(String spiderInfoJson) {
         List<Webpage> pages;
		try {
			pages = spiderService.testSpiderInfo(spiderInfoJson);
		} catch (JMException e) {
			e.printStackTrace();
			return R.error("执行失败！");
		}

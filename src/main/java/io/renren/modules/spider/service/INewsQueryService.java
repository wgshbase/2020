...
public interface INewsQueryService {
    ...
    /**
     * 根据关键字匹配标题检索*/
    public List<Map<String,Object>> searchMongoByQuery(String entityName,Map<String, Object> map,int pageIndex,int pageSize);

    /**
     * 根据关键字匹配标题检索总条数*/
    public long searchMongoCountByQuery(String entityName,Map<String, Object> map);

    /**
     * 根据id 获取news*/
    public Map<String,Object> searchMongoById(String entityName,String id);
     ...
     * @return
     */
    public Map<String, String> createReport(String params);

...
public class ExtractUtils {
	...
	private static String regexDomField = "(class=\".*?\"|width=\".*?\"|height=\".*?\"|srcset=\".*?\"|id=\".*?\"|sizes=\".*?\"|alt=\".*?\")";
	
	//private static String regexLable = "(<a.*?>|</a>|<script.*?>(.|\n)*?</script>|<iframe.*?>(.|\n)*?</iframe>)";
	
	private static String regexALable = "<a.*?>|</a>";
	
	private static String regexScriptLable = "<script.*?>.*?</script>";
	
	private static String regexIframeLable = "<iframe.*?>.*?</iframe>";

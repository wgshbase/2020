...
public class MiCaiPageProcessor  implements PageProcessor{
	private Logger logger = LoggerFactory.getLogger(MiCaiPageProcessor.class);
	...
	public MiCaiPageProcessor(){
		class1Map = new HashMap<String,String>();
		class1Map.put("http://www.micai.com/wuqi/46_0.html","飞行器");
...
/*		class1Map.put("https://shurufa.baidu.com/dict_list?cid=317","人文社会");
	...
	public static void main(String[] args){
		...
		MiCaiPageProcessor spp = new MiCaiPageProcessor();
